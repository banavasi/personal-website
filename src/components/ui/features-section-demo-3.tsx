  ...
  const features = [
    {
      ...
      description:
        "Architecting intelligent automation frameworks that reduce manual operations by 60% and accelerate development cycles.",
    ...
    },
    {
      ...
      description:
        "Designing scalable, multi-tenant cloud platforms serving 50K+ users with high availability.",
    ...
    },
    {
      ...
      description:
        "Leading distributed teams, mentoring 10+ engineers, and establishing best practices that drive measurable results.",
    ...
    },
    {
      title: "Global Impact",
      description:
        "Building enterprise-grade solutions deployed worldwide, powering critical business operations across multiple continents.",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        <h2 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
          Delivering Excellence Across the Stack
        </h2>

        <p className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          From AI-driven automation to cloud-native platforms, I bring 8+ years of expertise in building scalable, high-performance systems.
        </p>
      </div>
    ...
    >
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          <div className="h-20 w-20 absolute z-10 inset-0 text-blue-500 m-auto flex items-center justify-center text-6xl">
            👥
          </div>
          <img
      ...
      <div className="flex flex-row -ml-20">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 bg-neutral-800 dark:bg-neutral-800 dark:border-neutral-700 border border-neutral-100 shrink-0 overflow-hidden"
          >
            <img
              src={image}
