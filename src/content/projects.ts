export const projectsContent = {
  header: {
    title: "PROJECTS",
    description: "A selection of technical projects, architectural designs, and algorithmic solutions.",
  },
  projects: [
    ...
    },
    {
      ...
      period: "2024",
      description: "Production-ready GraphRAG database MVP with hybrid vector/graph search capabilities. Built with FastAPI, PostgreSQL 16, and Apache AGE. Features 49+ API endpoints, vector embeddings, graph-based knowledge extraction, multi-user RBAC, and cost tracking. Integrates with OpenRouter for LLM capabilities.",
    ...
    },
    {
      ...
      role: "Architect & Developer",
      period: "2024",
      description: "Phase 1 implementation of an email tracking system with webhook support. Built with Node.js, TypeScript, Express, Gmail API, Docker, and MongoDB. Features email sending, open tracking pixel, click tracking, webhook event processing, unsubscribe handling, and queue-based processing.",
    ...
    },
    {
      ...
      description: "Supporting the Starbucks College Achievement Plan (SCAP) - a partnership between ASU and Starbucks providing 100% tuition coverage for eligible partners pursuing their first bachelor's degree. The program offers 180+ online degree programs with full upfront tuition, no repayment requirements, and includes a pathway program for admission eligibility. Over 10,000 Starbucks partners have graduated through this program.",
    ...
    // ========== EARLY CAREER PROJECTS ==========
    {
      ...
      role: "Architect & Developer",
      period: "2014 - 2017",
      description: "A comprehensive system for understanding, maintaining, and implementing tracking ideas. Built to handle complex data streams and provide real-time visualization of tracked assets.",
      tags: ["System Design", "Real-time Data", "Tracking", "Analytics"],
    ...
    },
    {
      ...
      role: "Lead Developer",
      period: "2015 - 2016",
      description: "Predictive analytics tool fetching historical stock prices from Yahoo Finance to forecast ETF performance over a 5-year horizon. Provides personalized investment recommendations based on user risk profiles.",
      tags: ["Fintech", "Algorithms", "Data Analysis", "Prediction"],
    ...
    },
    {
      ...
      role: "Full Stack Developer",
      period: "2015",
      description: "Online booking platform for soccer grounds focused on user engagement. Streamlined the reservation process and built a community around local sports venues.",
      tags: ["E-commerce", "Booking System", "Community", "Web App"],
      image: "/images/project-astro.png",
      accent: "blue" as const,
      githubUrl: "",
      liveUrl: "",
    },
    {
      title: "Ecolibrium Energy",
      role: "Data Engineer",
      period: "2014",
      description: "Data crawling, analysis, and visualization project for Delhi Electricity Supply data. Created a POC to help visualize power consumption patterns and supply metrics.",
      tags: ["Data Visualization", "Crawling", "Analytics", "POC"],
      image: null,
    ...
    },
    {
      ...
      period: "2013",
      description: "Award-winning project from 'Random Hack Of Kindness'. Developed a talking LCD using Raspberry Pi and Python to assist visually impaired individuals in finding employment.",
      tags: ["IoT", "Python", "Accessibility", "Raspberry Pi"],
      image: null,
      accent: "green" as const,
      githubUrl: "",
      liveUrl: "",
